 ...
 * labels, cook time. Clicking opens the home cook's Quick View sheet.
 */
export function MealCard({
  ...
  return (
    <button
      ...
      className="group flex flex-col overflow-hidden rounded-md border border-zinc-200 bg-white text-left shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg focus-visible:outline-2 focus-visible:outline-accent-600"
    >
